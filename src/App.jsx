      ...
      <section id="pricing-section" className="py-20 md:py-28 bg-slate-900 relative">
        <div className="max-w-6xl mx-auto px-4 md:px-6 relative z-10 text-center text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-10">
            ...
            {/* 2. GOLD */}
            <div className="bg-amber-500 rounded-[2rem] p-1 shadow-2xl transform lg:-translate-y-4">
              <div className="bg-slate-950 rounded-[1.8rem] p-8 md:p-10 h-full flex flex-col text-left">
